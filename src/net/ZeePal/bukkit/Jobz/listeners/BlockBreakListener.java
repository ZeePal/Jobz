...
public class BlockBreakListener implements Listener {
	...
	public void onBlockBreakEvent(final BlockBreakEvent event){
		Jobz.scheduler.scheduleAsyncDelayedTask(Jobz.plugin, new BlockProcessorThread(event.getPlayer().getName(), (short) event.getBlock().getTypeId(), event.getBlock().getData(), Jobz.blockBreakValueListStorage));
	}
